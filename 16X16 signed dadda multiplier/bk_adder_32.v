...
module bk_add_sub(input [31:0] a,input [31:0] b,input mode,output [31:0] sum,output cout);
    wire [31:0] b_not;
    wire [31:0] b_sel;
    wire        cout_raw;
    ...
    generate
        for (i=0; i<32; i=i+1) begin
            not n1(b_not[i], b[i]);   // ~b
        end
    endgenerate

    generate
        for (i=0; i<32; i=i+1) begin
            assign b_sel[i] = mode ? b_not[i] : b[i];
        end
    endgenerate
    ...
    assign cout = mode ? ~cout_raw : cout_raw;
endmodule
